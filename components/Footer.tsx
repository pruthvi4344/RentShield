const footerLinks = {
  "For Renters": [
    ...
    { label: "Find a Roommate", href: "/roommates" },
    { label: "How It Works", href: "#how-it-works" },
    { label: "Student Housing", href: "/students" },
    { label: "Newcomer Guide", href: "/newcomers" },
  ],
  "For Landlords": [
    { label: "List Your Property", href: "/list" },
    { label: "Landlord Verification", href: "/verify-landlord" },
    { label: "Pricing", href: "/pricing" },
    { label: "Landlord Dashboard", href: "/dashboard" },
    { label: "Tips & Resources", href: "/resources" },
  ],
  "Trust & Safety": [
  ...
  "Company": [
    { label: "About RentShield", href: "/about" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-14 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-5">
              Safe, verified rentals for international students and newcomers across Canada.
            </p>
            {/* Social */}
            <div className="flex items-center gap-2">
              {socialLinks.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-9 h-9 rounded-lg bg-white/5 hover:bg-teal-500/20 hover:text-teal-400 flex items-center justify-center transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
        ...
        <div className="border-t border-white/5 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="/accessibility" className="hover:text-teal-400 transition-colors">Accessibility</a>
          </div>
        </div>
      </div>
    </footer>
